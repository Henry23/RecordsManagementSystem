...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tableViewRecords = new QTableView(centralWidget);
        tableViewRecords->setObjectName(QStringLiteral("tableViewRecords"));

        horizontalLayout->addWidget(tableViewRecords);
